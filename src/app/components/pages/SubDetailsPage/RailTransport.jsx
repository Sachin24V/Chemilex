                        ...
                        <div className="row">
                            <div className="col-lg-6 col-md-12">
                                <div className="mt-box">
                                    ...
                                    <p>
                                    Rail Transport is a highly efficient and reliable mode of transporting large quantities of goods over long distances. Known for its cost-effectiveness and environmental benefits, rail transport is ideal for moving bulk commodities such as minerals, coal, and raw materials. It provides a sustainable alternative to road transport, reducing congestion and minimizing carbon emissions.
                                    </p>
                                    <p>At Chemilex Industries, we leverage the advantages of rail transport to ensure the safe and timely delivery of our products. Our rail transport solutions are integrated into our logistics network, providing seamless connectivity between production sites, warehouses, and distribution points. By utilizing rail transport, we offer our clients a dependable and scalable transportation option that supports large-scale operations and enhances supply chain efficiency.
                                    </p>
                                </div>
                            </div>
                            <div className="col-lg-6 col-md-12">
