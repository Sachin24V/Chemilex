                        ...
                        <div className="row">
                            <div className="col-lg-6 col-md-12">
                                <div className="mt-box">
                                    ...
                                    <p>
                                    Colombian Met Coke, or Colombian metallurgical coke, is a high-quality coke produced from premium coking coal found in Colombia. It is known for its strong mechanical properties, high carbon content, and low impurity levels, making it ideal for use in steelmaking processes.
                                    </p>
                                    <p>At Chemilex Industries, our Colombian Met Coke is manufactured to meet stringent quality standards, ensuring reliable performance in blast furnaces. Its superior combustion characteristics and efficiency contribute to enhanced productivity in iron production, making it a preferred choice for steel producers seeking high-quality, effective coke solutions.
                                    </p>
                                </div>
                            </div>
                            <div className="col-lg-6 col-md-12">
