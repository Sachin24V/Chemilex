            ...
            <div className="row">
              <div className="col-lg-6 col-md-12">
                <div className="mt-box">
                  ...
                  <p>
                    Colombian ULP (Ultra-Low Phosphorus) coal is a specialized,
                    high-quality coal known for its exceptionally low phosphorus
                    content, making it ideal for applications where purity is
                    crucial. Sourced from Colombia's rich coal reserves,
                    Colombian ULP is favored in industries such as steel
                    manufacturing, where low phosphorus levels are essential to
                    prevent brittleness in the final steel product.
                  </p>
                  <p>
                    The Colombian ULP that meets the highest standards of
                    quality and consistency. Its low sulfur and phosphorus
                    content, coupled with high energy output, make it an
                    excellent choice for steelmakers seeking to produce
                    high-strength, durable steel. The superior performance of
                    Colombian ULP ensures efficient combustion and optimal
                    metallurgical properties, making it a preferred choice for
