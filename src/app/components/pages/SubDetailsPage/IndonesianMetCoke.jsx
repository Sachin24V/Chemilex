            ...
            <div className="row">
              <div className="col-lg-6 col-md-12">
                <div className="mt-box">
                  ...
                  <p>
                    Indonesian Met Coke, also known as metallurgical coke, is a
                    high-quality coke produced from premium Indonesian coking
                    coal. It is characterized by its strong mechanical
                    properties, high carbon content, and low impurities, making
                    it ideal for use in the steelmaking industry.
                  </p>
                  <p>
                    An Indonesian Met Coke is manufactured through advanced
                    processing techniques to ensure optimal performance in blast
                    furnaces and other metallurgical applications. It is used as
                    a crucial component in the production of molten iron,
                    providing the necessary heat and reducing atmosphere for
                    efficient ironmaking.
                  </p>
                  <p>
                    The high energy density and superior quality of Indonesian
                    Met Coke contribute to enhanced efficiency and productivity
                    in steel production, making it a preferred choice for
                    manufacturers seeking reliable and high-performance coke
                    solutions.
                  </p>
                </div>
              </div>
