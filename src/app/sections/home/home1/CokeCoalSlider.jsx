      ...
      <div className="breadcrumb-container">
          <nav aria-label="breadcrumb">
            <ol className="breadcrumb">
              ...
              <li className="breadcrumb-item active" aria-current="page">Indian/Imported Coal & Coke</li>
            </ol>
          </nav>
        </div>
            ...
            >
              ...
              >
                <ul>
                  ...
                  >
                    <FastImage
                      src="images/main-slider/slider1/coal & coke.jpg"
                      alt=""
                      data-lazyload={publicUrlFor(
                        "images/main-slider/slider1/coal & coke.jpg"
                      )}
                      data-bgposition="center center"
                      data-kenburns="on"
                      data-ease="Power1.easeOut"
                  ...
                  >
                    <FastImage
                      src="images/main-slider/slider1/coal & coke (2).jpg"
                      alt=""
                      data-lazyload={publicUrlFor(
                        "images/main-slider/slider1/coal & coke (2).jpg"
                      )}
                      data-bgposition="center center"
                      data-kenburns="on"
                      data-ease="Power1.easeOut"
                  ...
                  >
                    <FastImage
                      src="images/main-slider/slider1/coal & coke (3).jpg"
                      alt=""
                      data-lazyload={publicUrlFor(
                        "images/main-slider/slider1/coal & coke (3).jpg"
                      )}
                      data-bgposition="center center"
                      data-kenburns="on"
                      data-ease="Power1.easeOut"
                  ...
                  >
                    <FastImage
                      src="images/main-slider/slider1/coal & coke (4).jpg"
                      alt=""
                      data-lazyload={publicUrlFor(
                        "images/main-slider/slider1/coal & coke (4).jpg"
                      )}
                      data-bgposition="center center"
                      data-kenburns="on"
                      data-ease="Power1.easeOut"
